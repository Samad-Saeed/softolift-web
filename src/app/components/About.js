...
export default function about() {
    return (
        <div >
            ...
            {/* our team */}
            <h1 className="text-center font-bold text-2xl md:text-4xl mt-20 mb-5" style={{ fontFamily: 'Orbitron, sans-serif', color: '#FF5733'}}>Meet our team.</h1>
            ...
            <div className="items-center justify-center grid lg:grid-cols-3" style={{maxWidth:'1100px', margin: '0 auto'}}>
                    <div className="team-section flex flex-col text-center">
                        ...
                        <h2 className="font-bold text-xl"style={{fontFamily:'orbitron, sans-serif', color: '#000000',letterSpacing:'.20rem'}}>Sammad Saeed</h2>
                        <p style={{fontFamily:'noto sans', color: '#99a29e'}}>Full Stack Developer</p>
                    </div>
                    <div className="team-section flex flex-col text-center">
                        <img src="/images/person.jpg" alt="Image 1" />
                        <h2 className="font-bold text-xl"style={{fontFamily:'orbitron, sans-serif', color: '#000000'}}>Sammad Saeed</h2>
                        <p style={{fontFamily:'noto sans', color: '#99a29e'}}>Full Stack Developer</p>
                    </div>
                    <div className="team-section flex flex-col text-center">
                        <img src="/images/person.jpg" alt="Image 1" />
