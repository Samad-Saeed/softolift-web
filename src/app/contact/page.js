    ...
    <div className='bg-black overflow-auto'>
      <div className="flex grid md:grid-cols-2 gap-4" style={{height:'100vh' ,maxWidth: '1200px', margin:'0 auto'}}>
        ...
        <div className="form mt-16 ml-6">
          ...
          <div className='text-orange-900  mt-6 ml-6 mb-6'>
            <div class="border-t border-gray-300 my-8"></div>
            <h1 className='text-orange-700 text-xl font-bold mb-4'> Whats Next</h1>
          ...
          <div className=' text-orange-900  mt-6 ml-6 mb-6'>
              <div class="border-t border-gray-300 my-8"></div>
              <h1 className='text-orange-700 text-xl font-bold mb-4'>Social</h1>
